...
class ProductsServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('Modules\Products\Http\Repository\ProductRepository');
    ...
    {
        $this->publishes([
            module_path('Products', 'Config/config.php') => config_path('products.php'),
        ], 'config');
    ...
    public function registerViews()
    {
        ...
        $sourcePath = module_path('Products', 'Resources/views');
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(module_path('Products', 'Resources/lang'), 'products');
        }
    }
    ...
    public function registerFactories()
    {
        if (! app()->environment('production') && $this->app->runningInConsole()) {
            app(Factory::class)->load(module_path('Products', 'Database/factories'));
        }
    }
